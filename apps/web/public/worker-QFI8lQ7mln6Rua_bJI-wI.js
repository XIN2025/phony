(() => {
  ...
  var e = [
      ...
      (e, t, r) => {
        (r.r(t),
          r.d(t, {
            ...
            precache: () => l.precache,
            precacheAndRoute: () => h.precacheAndRoute,
          }));
        var a = r(3),
          n = r(32),
          s = r(44),
      ...
      (e, t, r) => {
        (r.r(t), r.d(t, { PrecacheController: () => h }));
        r(6);
        var a = r(11),
          n = (r(12), r(7)),
          s = r(13),
          ...
          constructor({ cacheName: e, plugins: t = [], fallbackToNetwork: r = !0 } = {}) {
            ((this._urlsToCacheKeys = new Map()),
              ...
              (this._strategy = new l.PrecacheStrategy({
                ...
                plugins: [...t, new c.PrecacheCacheKeyPlugin({ precacheController: this })],
                fallbackToNetwork: r,
              })),
            ...
            for (const r of e) {
              ...
              if ('string' != typeof r && r.integrity) {
                if (this._cacheKeysToIntegrities.has(e) && this._cacheKeysToIntegrities.get(e) !== r.integrity)
                  throw new n.WorkboxError('add-to-cache-list-conflicting-integrities', { url: a });
                this._cacheKeysToIntegrities.set(e, r.integrity);
              }
              if ((this._urlsToCacheKeys.set(a, e), this._urlsToCacheModes.set(a, s), t.length > 0)) {
            ...
            return (0, s.waitUntil)(e, async () => {
              ...
              for (const [t, r] of this._urlsToCacheKeys) {
                const a = this._cacheKeysToIntegrities.get(r),
                  ...
                  s = new Request(t, { integrity: a, cache: n, credentials: 'same-origin' });
                await Promise.all(this.strategy.handleAll({ params: { cacheKey: r }, request: s, event: e }));
              }
          ...
          activate(e) {
            return (0, s.waitUntil)(e, async () => {
              const e = await self.caches.open(this.strategy.cacheName),
                ...
                a = [];
              for (const n of t) r.has(n.url) || (await e.delete(n), a.push(n.url));
      ...
      (e, t, r) => {
        ...
        class n extends Error {
          constructor(e, t) {
            (super((0, a.messageGenerator)(e, t)), (this.name = e), (this.details = t));
          }
        }
      },
      (e, t, r) => {
      ...
      (e, t, r) => {
        ...
        const a = {
          ...
          'incorrect-type': ({ expectedType: e, paramName: t, moduleName: r, className: a, funcName: n }) => {
            if (!(e && t && r && n)) throw new Error("Unexpected input to 'incorrect-type' error.");
          ...
          'incorrect-class': ({
            ...
            if (!e || !r || !n) throw new Error("Unexpected input to 'incorrect-class' error.");
            const o = a ? `${a}.` : '';
            return s
          ...
          'missing-a-method': ({ expectedMethod: e, paramName: t, moduleName: r, className: a, funcName: n }) => {
            if (!(e && t && r && a && n)) throw new Error("Unexpected input to 'missing-a-method' error.");
      ...
      (e, t, r) => {
        ...
        function s(e) {
          if (!e) throw new a.WorkboxError('add-to-cache-list-unexpected-type', { entry: e });
          if ('string' == typeof e) {
            const t = new URL(e, location.href);
      ...
      (e, t, r) => {
        ...
        function s(e, t) {
          ...
          if (r || s) {
            ...
            (s > 0 && (o += ` ${s} file${1 === s ? ' is' : 's are'} already cached.`),
      ...
      (e, t, r) => {
        ...
        class i extends o.Strategy {
          ...
          async _handle(e, t) {
            ...
            return (
              r ||
              (t.event && 'install' === t.event.type ? await this._handleInstall(e, t) : await this._handleFetch(e, t))
            );
          }
          async _handleFetch(e, t) {
            ...
            if (!this._fallbackToNetwork)
              throw new s.WorkboxError('missing-precache-entry', { cacheName: this.cacheName, url: e.url });
            {
              0;
              const n = a.integrity,
                s = e.integrity,
                o = !s || s === n;
              if (
                ((r = await t.fetch(new Request(e, { integrity: 'no-cors' !== e.mode ? s || n : void 0 }))),
                n && o && 'no-cors' !== e.mode)
              ) {
          ...
          async _handleInstall(e, t) {
            ...
            if (!(await t.cachePut(e, r.clone())))
              throw new s.WorkboxError('bad-precaching-response', { url: e.url, status: r.status });
            return r;
          }
          _useDefaultCacheabilityPluginIfNeeded() {
            ...
            for (const [r, a] of this.plugins.entries())
              a !== i.copyRedirectedCacheableResponsesPlugin &&
                (a === i.defaultPrecacheCacheabilityPlugin && (e = r), a.cacheWillUpdate && t++);
            0 === t
        ...
        ((i.defaultPrecacheCacheabilityPlugin = {
          ...
          (i.copyRedirectedCacheableResponsesPlugin = {
            cacheWillUpdate: async ({ response: e }) => (e.redirected ? await (0, a.copyResponse)(e) : e),
          }));
      },
      (e, t, r) => {
        ...
        async function s(e, t) {
          ...
          if (r !== self.location.origin) throw new n.WorkboxError('cross-origin-copy-response', { origin: r });
          const s = e.clone(),
            o = { headers: new Headers(s.headers), status: s.status, statusText: s.statusText },
            i = t ? t(o) : o,
            c = (0, a.canConstructResponseFromBodyStream)() ? s.body : await s.blob();
        ...
        class o {
          ...
          handleAll(e) {
            ...
            const t = e.event,
              ...
              n = new s.StrategyHandler(this, { event: t, request: r, params: a }),
            ...
            try {
              ...
              if (n instanceof Error)
                for (const s of e.iterateCallbacks('handlerDidError'))
                  if (((a = await s({ error: n, event: r, request: t })), a)) break;
              if (!a) throw n;
            }
          ...
          async _awaitComplete(e, t, r, a) {
            ...
            try {
              (await t.runCallbacks('handlerDidRespond', { event: a, request: r, response: n }), await t.doneWaiting());
            } catch (e) {
              e instanceof Error && (s = e);
            }
            if (
              (await t.runCallbacks('handlerDidComplete', { event: a, request: r, response: n, error: s }),
              t.destroy(),
              s)
            )
              throw s;
      ...
      (e, t, r) => {
        ...
        class h {
          ...
          async fetch(e) {
            ...
            try {
              for (const e of this.iterateCallbacks('requestWillFetch')) r = await e({ request: r.clone(), event: t });
            } catch (e) {
              if (e instanceof Error)
                throw new c.WorkboxError('plugin-error-request-will-fetch', { thrownErrorMessage: e.message });
            }
            const n = r.clone();
            try {
              let e;
          ...
          async cacheMatch(e) {
            ...
            for (const e of this.iterateCallbacks('cachedResponseWillBeUsed'))
              r =
                (await e({ cacheName: a, matchOptions: n, cachedResponse: r, request: s, event: this.event })) ||
                void 0;
            return r;
          }
          async cachePut(e, t) {
            ...
            if (!t) throw new c.WorkboxError('cache-put-with-no-response', { url: (0, o.getFriendlyURL)(n.url) });
            const h = await this._ensureResponseSafeToCache(t);
            if (!h) return !1;
          ...
          async getCacheKey(e, t) {
            ...
            if (!this._cacheKeys[r]) {
              ...
              for (const e of this.iterateCallbacks('cacheKeyWillBeUsed'))
                a = l(await e({ mode: t, request: a, event: this.event, params: this.params }));
              this._cacheKeys[r] = a;
            }
          ...
          *iterateCallbacks(e) {
          ...
          async _ensureResponseSafeToCache(e) {
            ...
            for (const e of this.iterateCallbacks('cacheWillUpdate'))
              if (((t = (await e({ request: this.request, response: t, event: this.event })) || void 0), (r = !0), !t))
                break;
      ...
      (e, t, r) => {
        ...
        class s {
          constructor(e, t, r = a.defaultMethod) {
            ((this.handler = (0, n.normalizeHandler)(t)), (this.match = e), (this.method = r));
          }
          setCatchHandler(e) {
      ...
      (e, t, r) => {
        ...
        r(36);
        let n;
        const s = () => (n || ((n = new a.Router()), n.addFetchListener(), n.addCacheListener()), n);
      },
      (e, t, r) => {
        ...
        class o {
          ...
          handleRequest({ request: e, event: t }) {
            ...
            const a = r.origin === location.origin,
              { params: n, route: s } = this.findMatchingRoute({ event: t, request: e, sameOrigin: a, url: r });
            let o = s && s.handler;
            const i = e.method;
            if ((!o && this._defaultHandlerMap.has(i) && (o = this._defaultHandlerMap.get(i)), !o)) return void 0;
            let c;
            try {
              ...
              c instanceof Promise &&
                ...
                (c = c.catch(async (a) => {
                  if (l) {
                    0;
                    try {
                      return await l.handle({ url: r, request: e, event: t, params: n });
                    } catch (e) {
          ...
          unregisterRoute(e) {
            if (!this._routes.has(e.method))
              throw new s.WorkboxError('unregister-route-but-not-found-with-method', { method: e.method });
            const t = this._routes.get(e.method).indexOf(e);
            if (!(t > -1)) throw new s.WorkboxError('unregister-route-route-not-registered');
      ...
      (e, t, r) => {
        ...
        r(15);
        function n(e) {
          return (0, a.getOrCreatePrecacheController)().createHandlerBoundToURL(e);
        }
      },
      (e, t, r) => {
        ...
        class n {
          constructor({ fallbackURL: e, precacheController: t }) {
            ((this.handlerDidError = () => this._precacheController.matchPrecache(this._fallbackURL)),
              (this._fallbackURL = e),
              (this._precacheController = t || (0, a.getOrCreatePrecacheController)()));
          }
        }
      },
      (e, t, r) => {
      ...
      (e, t, r) => {
        ...
        class s extends n.Strategy {
          async _handle(e, t) {
            ...
            if (!n) throw new a.WorkboxError('no-response', { url: e.url, error: r });
            return n;
          }
        }
      },
      (e, t, r) => {
        ...
        r(31);
        const s = {
          strategyStart: (e, t) => `Using ${e} to respond to '${(0, n.getFriendlyURL)(t.url)}'`,
      ...
      (e, t, r) => {
        ...
        class o extends s.Strategy {
          constructor(e = {}) {
            (super(e),
              this.plugins.some((e) => 'cacheWillUpdate' in e) || this.plugins.unshift(n.cacheOkAndOpaquePlugin),
          ...
          async _handle(e, t) {
            ...
            if (this._networkTimeoutSeconds) {
              const { id: a, promise: o } = this._getTimeoutPromise({ request: e, logs: r, handler: t });
              ((s = a), n.push(o));
            }
            const o = this._getNetworkPromise({ timeoutId: s, request: e, logs: r, handler: t });
            n.push(o);
            const i = await t.waitUntil((async () => (await t.waitUntil(Promise.race(n))) || (await o))());
          ...
          async _getNetworkPromise({ timeoutId: e, request: t, logs: r, handler: a }) {
            let n, s;
            try {
            ...
            return (e && clearTimeout(e), (!n && s) || (s = await a.cacheMatch(t)), s);
          }
        }
      },
      (e, t, r) => {
        ...
        r(31);
        const a = { cacheWillUpdate: async ({ response: e }) => (200 === e.status || 0 === e.status ? e : null) };
      },
      (e, t, r) => {
        ...
        class o extends s.Strategy {
          ...
          async _handle(e, t) {
            ...
            if (!s) throw new n.WorkboxError('no-response', { url: e.url, error: r });
            return s;
          }
        }
      },
      (e, t, r) => {
        ...
        class o extends s.Strategy {
          ...
          async _handle(e, t) {
            ...
            if (!s) throw new a.WorkboxError('no-response', { url: e.url, error: n });
            return s;
          }
        }
      },
      (e, t, r) => {
        (r.r(t),
          r.d(t, {
            ...
            CacheableResponsePlugin: () => a.CacheableResponsePlugin,
          }));
        var a = r(68);
      },
      (e, t, r) => {
        (r.r(t),
          r.d(t, {
            CacheableResponse: () => a.CacheableResponse,
            CacheableResponsePlugin: () => n.CacheableResponsePlugin,
          }));
        var a = r(69),
          n = r(71);
        r(70);
      ...
      (e, t, r) => {
        (r.r(t), r.d(t, { CacheableResponsePlugin: () => n }));
        var a = r(69);
        r(70);
        class n {
          constructor(e) {
            ((this.cacheWillUpdate = async ({ response: e }) =>
              ...
              (this._cacheableResponse = new a.CacheableResponse(e)));
          }
        }
      },
      (e, t, r) => {
        (r.r(t), r.d(t, { CacheExpiration: () => a.CacheExpiration, ExpirationPlugin: () => a.ExpirationPlugin }));
        var a = r(73);
      },
      (e, t, r) => {
        (r.r(t), r.d(t, { CacheExpiration: () => a.CacheExpiration, ExpirationPlugin: () => n.ExpirationPlugin }));
        var a = r(74),
          n = r(84);
        r(83);
      },
      (e, t, r) => {
        ...
        class s {
          ...
          async expireEntries() {
            ...
            ((this._isRunning = !1),
              this._rerunRequested && ((this._rerunRequested = !1), (0, a.dontWaitFor)(this.expireEntries())));
          }
      ...
      (e, t, r) => {
        ...
        class o {
          ...
          _upgradeDbAndDeleteOldDbs(e) {
            (this._upgradeDb(e), this._cacheName && (0, a.deleteDB)(this._cacheName));
          }
          async setTimestamp(e, t) {
            const r = { url: (e = s(e)), timestamp: t, cacheName: this._cacheName, id: this._getId(e) },
              a = (await this.getDb()).transaction(n, 'readwrite', { durability: 'relaxed' });
          ...
          async expireEntries(e, t) {
            ...
            for (; a; ) {
              const r = a.value;
              (r.cacheName === this._cacheName && ((e && r.timestamp < e) || (t && o >= t) ? s.push(a.value) : o++),
                (a = await a.continue()));
            }
            const i = [];
      ...
      (e, t, r) => {
        (r.r(t), r.d(t, { deleteDB: () => c, openDB: () => i, unwrap: () => n.u, wrap: () => n.w }));
        var a = r(78),
          n = r(82);
        function s(e, t) {
          var r = Object.keys(e);
        ...
        function i(e, t, { blocked: r, upgrade: a, blocking: s, terminated: o } = {}) {
          const i = indexedDB.open(e, t),
            c = (0, n.w)(i);
          return (
            a &&
              i.addEventListener('upgradeneeded', (e) => {
                a((0, n.w)(i.result), e.oldVersion, e.newVersion, (0, n.w)(i.transaction), e);
              }),
        ...
        function c(e, { blocked: t } = {}) {
          ...
          return (t && r.addEventListener('blocked', (e) => t(e.oldVersion, e)), (0, n.w)(r).then(() => {}));
        }
        ...
        function d(e, t) {
          ...
          const r = t.replace(/FromIndex$/, ''),
            a = t !== r,
            n = h.includes(r);
          if (!(r in (a ? IDBIndex : IDBObjectStore).prototype) || (!n && !l.includes(r))) return;
          const s = async function (e, ...t) {
            const s = this.transaction(e, n ? 'readwrite' : 'readonly');
            let o = s.store;
            return (a && (o = o.index(t.shift())), (await Promise.all([o[r](...t), n && s.done]))[0]);
          };
          return (u.set(t, s), s);
        }
        (0, n.r)((e) =>
          o(o({}, e), {}, { get: (t, r, a) => d(t, r) || e.get(t, r, a), has: (t, r) => !!d(t, r) || e.has(t, r) }),
        );
      },
      (e, t, r) => {
        ...
        function g(e) {
          return 'function' == typeof e
            ...
            : (e instanceof IDBTransaction &&
              ...
              a(e, n || (n = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]))
                ? new Proxy(e, u)
                : e);
        }
        function f(e) {
      ...
      (e, t, r) => {
        ...
        class c {
          constructor(e = {}) {
            ((this.cachedResponseWillBeUsed = async ({ event: e, request: t, cacheName: r, cachedResponse: a }) => {
              if (!a) return null;
              ...
              e.purgeOnQuotaError && (0, s.registerQuotaErrorCallback)(() => this.deleteCacheAndMetadata()));
          }
          _getCacheExpiration(e) {
            if (e === a.cacheNames.getRuntimeName()) throw new o.WorkboxError('expire-custom-caches-only');
            let t = this._cacheExpirations.get(e);
            return (t || ((t = new i.CacheExpiration(e, this._config)), this._cacheExpirations.set(e, t)), t);
          }
