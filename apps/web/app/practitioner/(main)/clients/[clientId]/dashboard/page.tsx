  ...
  daily: [
    {
      ...
      achieved: '-',
      potentialActions: [
        'Try a 20-minute High-Intensity Interval Training (HIIT) workout at home.',
        'Go for a 30-minute brisk walk or light jog.',
        'Take a 30-minute swim, alternating between faster and slower laps.',
      ],
      whyThisHelps:
        'To help lift your low mood, cardio exercise is key. It stimulates the release of endorphins, which are powerful, natural mood-boosting neurochemicals that create feelings of well-being which can help depressive states.',
      toolsToHelp: [
        {
          title: '30 min HIIT workout',
          type: 'hyperlink',
          url: 'https://example.com/hiit-workout',
        },
        {
          title: 'Importance of workouts',
          type: 'PDF Doc',
        },
      ],
    },
  ...
  consistent: [
    {
      ...
      whyThisHelps: 'Good sleep hygiene is essential for mental health recovery and emotional regulation.',
      toolsToHelp: [
        {
...
export default function ClientDashboardPage({ params }: { params: Promise<{ clientId: string }> }) {
  ...
  return (
    <>
      ...
      {/* Task Detail Modal - Outside main container */}
