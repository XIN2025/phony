      ...
      {client && !client.trackingEnabled && (
        <div className='bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h3 className='font-semibold text-amber-800'>Progress Tracking Disabled</h3>
              <p className='text-sm text-amber-700'>
                This client has disabled progress tracking. You won't be able to see their task completions, journal
                entries, or other progress data.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-full lg:gap-4'>
        <div className='bg-white rounded-2xl shadow-md border border-[#ececec] p-6 lg:p-4 flex flex-col items-start gap-2'>
          <div className='flex items-center justify-between w-full'>
            ...
            >
              {client && !client.trackingEnabled ? '—' : `${completion}%`}
            </div>
            <ClipboardList className='h-10 w-10 text-[#807171]' />
          </div>
          <div className='text-base font-semibold text-black/80 '>
            {client && !client.trackingEnabled ? 'Tracking Disabled' : 'Avg Daily Tasks Completion'}
          </div>
        </div>
        <div className='bg-white rounded-2xl shadow-md border border-[#ececec] p-6 lg:p-4 flex flex-col items-start gap-2'>
          <div className='flex items-center justify-between w-full'>
            <div
              ...
              style={{ fontFamily: "'DM Serif Display', serif", color: '#807171' }}
            >
              {client && !client.trackingEnabled ? '—' : filteredJournals.length}
            </div>
            <BookText className='h-10 w-10 text-[#807171]' />
          </div>
          <div className='text-base font-semibold text-black/80'>
            {client && !client.trackingEnabled ? 'Tracking Disabled' : 'Journal Entries'}
          </div>
        </div>
      </div>
