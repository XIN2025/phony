...
export const JournalDetailModal: React.FC<JournalDetailModalProps> = ({ open, onClose, journal }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className='!fixed !top-1/2 !left-1/2 !transform !-translate-x-1/2 !-translate-y-1/2 w-[95vw] max-w-3xl max-h-[90vh] sm:max-h-[80vh] overflow-hidden !z-[9999]'>
